	...
	<div class="top-bar">
		<div class="container">
			...
			<div class="tb-contact pull-left">
				<!-- Email -->
				<i class="fa fa-envelope color"></i> &nbsp; <a href="mailto:nguyenvanquocdh1995@gmail.com">lehugnphu1412@gmail.com</a>
				&nbsp;&nbsp;
				<!-- Phone -->
				<i class="fa fa-phone color"></i> &nbsp; +84 (97)-(466)-(8074)
			</div>
			<!-- Contact ends -->
				...
				<div class="b-dropdown-block">
					...
					<ul class="list-unstyled">
						...
						<li>
							<!-- Item image -->
							<div class="cart-img">
								<a href="#"><img src="{{asset('img/ecommerce/view-cart/1.png')}}" alt="" class="img-responsive" /></a>
							</div>
						...
						<li>
							<div class="cart-img">
								<a href="#"><img src="{{asset('img/ecommerce/view-cart/2.png')}}" alt="" class="img-responsive" /></a>
							</div>
							<div class="cart-title">
								<h5><a href="#">Premium Quality Shirt</a></h5>
