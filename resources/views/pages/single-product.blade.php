					...
					<div class="row">
						...
						<div class="col-md-5 col-sm-6 summary-before ">
							...
							<div class="product-slider product-shop">
								...
								<ul class="slides">
									<li data-thumb="{{asset('img/temp-images/hoodie_7_front-140x140.jpg')}}">
										<a href="{{asset('img/temp-images/hoodie_7_front.jpg')}}" data-imagelightbox="gallery" class="hoodie_7_front">
											<img src="{{asset('img/temp-images/hoodie_7_front-470x470.jpg')}}" class="attachment-shop_single" alt="image">
										</a>
									</li>
									<li data-thumb="{{asset('img/temp-images/hoodie_7_back-140x140.jpg')}}">
										<a href="{{asset('img/temp-images/hoodie_7_back.jpg')}}" data-imagelightbox="gallery" class="hoodie_7_back">
											<img src="{{asset('img/temp-images/hoodie_7_back-470x470.jpg')}}" class="attachment-shop_single" alt="image">
										</a>
									</li>
												...
												<div id="product-carousel" class="product-listing">
													...
													<div class="product  item first ">
														...
														<article>
															...
															<figure>
																<a href="#">
																	<img src="{{asset('img/temp-images/T_2_front-300x300.jpg')}}" class="img-responsive" alt="T_2_front">
																</a>
													...
													<div class="product  item first ">
														...
														<article>
															...
															<figure>
																<a href="#">
																	<img src="{{asset('img/temp-images/T_5_front-300x300.jpg')}}" class="img-responsive " alt="T_5_front">
																</a>
																<figcaption><span class="amount">$20.00</span></figcaption>
															</figure>
													...
													<div class="product  item first ">
														...
														<article>
															...
															<figure>
																<a href="#">
																	<img src="{{asset('img/temp-images/hoodie_2_front-300x300.jpg')}}" class="img-responsive" alt="hoodie_2_front">
																</a>
													...
													<div class="product  item first ">
														...
														<article>
															...
															<figure>
																<a href="#">
																	<img src="{{asset('img/temp-images/T_4_front-300x300.jpg')}}" class="img-responsive" alt="T_4_front">
																</a>
																<figcaption>
													...
													<div class="product  item first ">
														...
														<article>
															...
															<figure>
																<a href="#">
																	<img src="{{asset('img/temp-images/T_7_front-300x300.jpg')}}" class="img-responsive" alt="T_7_front">
																</a>
													...
													<div class="product  item first ">
														...
														<article>
															...
															<figure>
																<a href="#">
																	<img src="{{asset('img/temp-images/T_6_front-300x300.jpg')}}" class="img-responsive" alt="T_6_front">
																</a>
																<figcaption><span class="amount">$20.00</span></figcaption>
															</figure>
													...
													<div class="product  item first ">
														...
														<article>
															...
															<figure>
																<a href="#">
																	<img src="{{asset('img/temp-images/hoodie_4_front-300x300.jpg')}}" class="img-responsive" alt="hoodie_4_front">
																</a>
																<figcaption><span class="amount">$35.00</span></figcaption>
															</figure>
													...
													<div class="product  item first ">
														...
														<article>
															...
															<figure>
																<a href="#">
																	<img src="{{asset('img/temp-images/hoodie_3_front-300x300.jpg')}}" class="img-responsive" alt="hoodie_3_front">
																</a>
																<figcaption><span class="amount">$35.00</span></figcaption>
															</figure>
													...
													<ol class="commentlist">
														<li class="comment depth-1">
															...
															<div class="comment_container">
																...
																<img alt="gravatar" src="{{asset('img/temp-images/com-grav1.jpg')}}" class="avatar photo">
                                            ...
                                            <i class="fa fa-star-o"></i>
														...
														<li class="comment  depth-1">
															...
															<div class="comment_container">
																...
																<img src="{{asset('img/temp-images/com-grav2.jpg')}}" alt="image" class="avatar photo">
																<div class="comment-text">
                                            ...
                                            <i class="fa fa-star-o"></i>
														...
														<li class="comment depth-1">
															...
															<div class="comment_container">
																...
																<img src="{{asset('img/temp-images/com-grav3.jpg')}}" alt="image" class="avatar photo">
																<div class="comment-text">
